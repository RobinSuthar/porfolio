...
import qpay1 from "../Images/qpaymen1.png";
import qpay2 from "../Images/qpaymen2.png";
import qpay3 from "../Images/qpaymen3.png";
import qpay4 from "../Images/qpaymen4.png";
import h1 from "../Images/hbot1.png";
  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            built and launched a payment system using fake money, essentially
            creating a simulated financial platform for testing, learning, or
            demonstration purposes.
            <div>
              <Button className="mt-3">
                {" "}
                <a href="https://qpayment-mauve.vercel.app/">Explore</a>
              </Button>
            </div>
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            AI-powered website that provides personalized wine recommendations
            tailored to each customer's preferences. The site is designed to
            enhance the shopping experience by offering expert-level wine
            suggestions based on various factors, including taste preferences,
            food pairings, budget, and occasion.
            <div>
              <Button className="mt-3">
                {" "}
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            To-Do Manager is a powerful and intuitive application designed to
            help individuals and teams stay organized. It provides a structured
            approach to managing tasks, ensuring that every task is categorized
            based on priority and assigned responsibility.
            <div>
              <Button className="mt-3">
                {" "}
